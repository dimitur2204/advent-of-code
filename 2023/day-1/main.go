...
func sumDigits(str string) int {
	...
	strDigit := ""
	for i := 0; i < len(str); i++ {
		runeStr := string(str[i])
		digit := int(runeStr[0]) - 48
		strDigit += runeStr
		if strings.Contains(strDigit, "one") {
			digit = 1
            strDigit = strDigit[len(strDigit)-1:]
			if firstDigit == -1 {
				firstDigit = digit
			}
			lastDigit = digit

		} else if strings.Contains(strDigit, "two") {
			digit = 2
            strDigit = strDigit[len(strDigit)-1:]
			if firstDigit == -1 {
				firstDigit = digit
		...
		} else if strings.Contains(strDigit, "three") {
			digit = 3
            strDigit = strDigit[len(strDigit)-1:]
			if firstDigit == -1 {
				firstDigit = digit
		...
		} else if strings.Contains(strDigit, "four") {
			digit = 4
            strDigit = strDigit[len(strDigit)-1:]
			if firstDigit == -1 {
				firstDigit = digit
		...
		} else if strings.Contains(strDigit, "five") {
			digit = 5
            strDigit = strDigit[len(strDigit)-1:]
			if firstDigit == -1 {
				firstDigit = digit
			...
			lastDigit = digit
		} else if strings.Contains(strDigit, "six") {
			digit = 6
            strDigit = strDigit[len(strDigit)-1:]
			if firstDigit == -1 {
				firstDigit = digit
		...
		} else if strings.Contains(strDigit, "seven") {
			digit = 7
            strDigit = strDigit[len(strDigit)-1:]
			if firstDigit == -1 {
				firstDigit = digit
		...
		} else if strings.Contains(strDigit, "eight") {
			digit = 8
            strDigit = strDigit[len(strDigit)-1:]
			if firstDigit == -1 {
				firstDigit = digit
			...
			lastDigit = digit
		} else if strings.Contains(strDigit, "nine") {
			digit = 9
            strDigit = strDigit[len(strDigit)-1:]
			if firstDigit == -1 {
				firstDigit = digit
        ...
        fmt.Println(strDigit)
	}
	fmt.Println(str + " - " + "firstDigit", firstDigit, "lastDigit", lastDigit)
